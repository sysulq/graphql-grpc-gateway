...
const (
	Service_Mutate1_FullMethodName           = "/optionsserver.Service/Mutate1"
	Service_Mutate2_FullMethodName           = "/optionsserver.Service/Mutate2"
	Service_Query1_FullMethodName            = "/optionsserver.Service/Query1"
	Service_Query2_FullMethodName            = "/optionsserver.Service/Query2"
	Service_Publish_FullMethodName           = "/optionsserver.Service/Publish"
	Service_Subscribe_FullMethodName         = "/optionsserver.Service/Subscribe"
	Service_PubSub1_FullMethodName           = "/optionsserver.Service/PubSub1"
	Service_InvalidSubscribe1_FullMethodName = "/optionsserver.Service/InvalidSubscribe1"
...
func (c *serviceClient) Query2(ctx context.Context, in *Data, opts ...grpc.CallOption) (*Data, error) {
	out := new(Data)
	err := c.cc.Invoke(ctx, Service_Query2_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_Query2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_Query2_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Service_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "example/optionsserver/options.proto",
}

const (
	Test_Name_FullMethodName    = "/optionsserver.Test/Name"
	Test_NewName_FullMethodName = "/optionsserver.Test/NewName"
)
...
const (
	Query_Query1_FullMethodName    = "/optionsserver.Query/Query1"
	Query_Query2_FullMethodName    = "/optionsserver.Query/Query2"
	Query_Mutate1_FullMethodName   = "/optionsserver.Query/Mutate1"
	Query_Subscribe_FullMethodName = "/optionsserver.Query/Subscribe"
)
