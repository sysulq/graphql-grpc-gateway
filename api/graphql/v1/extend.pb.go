...
func (Upstream) Descriptor() protoreflect.EnumDescriptor {
	return file_graphql_v1_extend_proto_enumTypes[1].Descriptor()
}

func (Upstream) Type() protoreflect.EnumType {
	return &file_graphql_v1_extend_proto_enumTypes[1]
}
...
type Svc struct {
	...
	Ignore   bool     `protobuf:"varint,2,opt,name=ignore,proto3" json:"ignore,omitempty"`
	Name     string   `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
	Upstream Upstream `protobuf:"varint,4,opt,name=upstream,proto3,enum=graphql.v1.Upstream" json:"upstream,omitempty"`
}

func (x *Svc) Reset() {
	*x = Svc{}
	if protoimpl.UnsafeEnabled {
		mi := &file_graphql_v1_extend_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Svc) Descriptor() ([]byte, []int) {
	return file_graphql_v1_extend_proto_rawDescGZIP(), []int{3}
}
...
var (
	// optional graphql.v1.Rpc rpc = 65030;
	E_Rpc = &file_graphql_v1_extend_proto_extTypes[0]
)

// Extension fields to descriptorpb.ServiceOptions.
var (
	// optional graphql.v1.Svc svc = 65030;
	E_Svc = &file_graphql_v1_extend_proto_extTypes[1]
)

// Extension fields to descriptorpb.FieldOptions.
var (
	// optional graphql.v1.Field field = 65030;
	E_Field = &file_graphql_v1_extend_proto_extTypes[2]
)

// Extension fields to descriptorpb.OneofOptions.
var (
	// optional graphql.v1.Oneof oneof = 65030;
	E_Oneof = &file_graphql_v1_extend_proto_extTypes[3]
)
...
var file_graphql_v1_extend_proto_rawDesc = []byte{
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x7b, 0x0a, 0x05,
	...
	0x09, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x69, 0x72,
	0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x69, 0x72, 0x73, 0x12, 0x16, 0x0a,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x57, 0x0a, 0x03, 0x52, 0x70, 0x63,
	0x12, 0x24, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10,
	0x2e, 0x67, 0x72, 0x61, 0x70, 0x68, 0x71, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x79, 0x70, 0x65,
	...
	,
	...
	,
...
var file_graphql_v1_extend_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_graphql_v1_extend_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_graphql_v1_extend_proto_goTypes = []interface{}{
	(Type)(0),                           // 0: graphql.v1.Type
	(Upstream)(0),                       // 1: graphql.v1.Upstream
	(*Oneof)(nil),                       // 2: graphql.v1.Oneof
	(*Field)(nil),                       // 3: graphql.v1.Field
	(*Rpc)(nil),                         // 4: graphql.v1.Rpc
	(*Svc)(nil),                         // 5: graphql.v1.Svc
...
var file_graphql_v1_extend_proto_depIdxs = []int32{
	...
	0,  // 1: graphql.v1.Svc.type:type_name -> graphql.v1.Type
	1,  // 2: graphql.v1.Svc.upstream:type_name -> graphql.v1.Upstream
	6,  // 3: graphql.v1.rpc:extendee -> google.protobuf.MethodOptions
	7,  // 4: graphql.v1.svc:extendee -> google.protobuf.ServiceOptions
	8,  // 5: graphql.v1.field:extendee -> google.protobuf.FieldOptions
	9,  // 6: graphql.v1.oneof:extendee -> google.protobuf.OneofOptions
	4,  // 7: graphql.v1.rpc:type_name -> graphql.v1.Rpc
	5,  // 8: graphql.v1.svc:type_name -> graphql.v1.Svc
	3,  // 9: graphql.v1.field:type_name -> graphql.v1.Field
	2,  // 10: graphql.v1.oneof:type_name -> graphql.v1.Oneof
...
func file_graphql_v1_extend_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_graphql_v1_extend_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Svc); i {
			case 0:
				return &v.state
			case 1:
